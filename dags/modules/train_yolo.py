...
class YOLOModel:
    def __init__(self, experiment_name="yolo", run_name="yolo11n-onnx", model_path="yolo11n.pt"):
        print("YOLO 모델 로드 중...")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--run_name", type=str, default="yolo11n-onnx", help="mlflow run name & model name")
