...
이 레포지토리는 모두의 연구소 강의 https://class.modulabs.co.kr/classes/24 에서 쓰이는 실습용 레포지토리입니다. 자세한 실습 강의를 듣고 싶으신 분들은 참고하시기 바랍니다.

MLOps의 전체 라이프사이클을 자동화된 파이프라인으로 경험해볼 수 있도록 설계되어 있습니다. 
